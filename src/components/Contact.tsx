const Contact = () => {
  return (
    <section id="contact" className="py-20 bg-spa-cream relative overflow-hidden">
      {/* Decorative Background Elements */}
      <div className="absolute inset-0 z-0">
        {/* Organic Blob Shapes - Much Bigger */}
        <div className="absolute top-24 left-16 w-48 h-48 bg-spa-accent/15 transform rotate-45"
             style={{borderRadius: '30% 70% 70% 30% / 30% 30% 70% 70%'}}></div>
        <div className="absolute top-40 right-20 w-40 h-64 bg-spa-earth/10 transform -rotate-12" 
             style={{borderRadius: '60% 40% 30% 70% / 60% 30% 70% 40%'}}></div>
        <div className="absolute bottom-40 left-32 w-56 h-56 bg-spa-stone/10"
             style={{borderRadius: '40% 60% 70% 30% / 40% 70% 30% 60%'}}></div>
        <div className="absolute bottom-24 right-40 w-64 h-32 bg-spa-accent/10 transform rotate-12" 
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-spa-text/80 max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-8">
            <h3 className="text-2xl font-serif text-spa-text mb-8">Contact Information</h3>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <p className="text-spa-text font-medium">Erin Pitts</p>
                  <p className="text-spa-text/70">01234 567890</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <p className="text-spa-text font-medium">Email</p>
                  <p className="text-spa-text/70">info@freereinpilates.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <p className="text-spa-text font-medium">Location</p>
                  <p className="text-spa-text/70">Shefford, Bedfordshire (SG17)</p>
                </div>
              </div>
            </div>
            ...
            {/* Social Links */}
            <div className="pt-8">
              <h4 className="text-lg font-serif text-spa-text mb-4">Follow Us</h4>
              <div className="flex space-x-4">
                <a href="#" className="text-spa-earth hover:text-spa-accent transition-colors duration-200">
        ...
        {/* Footer */}
        <footer className="mt-20 pt-16 border-t border-spa-stone/20">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            ...
            <div className="text-center md:text-left">
              ...
              />
              <p className="text-spa-text/70 text-sm leading-relaxed">
            ...
            <div className="text-center">
              ...
              <ul className="space-y-3 text-sm text-spa-text/70">
                <li><a href="#services" className="hover:text-spa-accent transition-colors">Mat Pilates Courses</a></li>
                <li><a href="#services" className="hover:text-spa-accent transition-colors">1-2-1 Studio Sessions</a></li>
                <li><a href="#services" className="hover:text-spa-accent transition-colors">Sports Therapy</a></li>
                <li><a href="#services" className="hover:text-spa-accent transition-colors">Equestrian Pilates</a></li>
                <li><a href="#services" className="hover:text-spa-accent transition-colors">Day Retreats</a></li>
              </ul>
            </div>
            ...
            <div className="text-center md:text-right">
              ...
              <div className="space-y-3 text-sm text-spa-text/70">
                <p>Erin Pitts</p>
              ...
              <div className="flex justify-center md:justify-end space-x-4 mt-6">
                <a href="#" className="text-spa-earth hover:text-spa-accent transition-colors">
          ...
          <div className="pt-8 border-t border-spa-stone/20 text-center">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
              <p className="text-spa-text/50 text-sm">
                &copy; 2024 Free Rein Pilates Ltd. All rights reserved.
              </p>
              <p className="text-spa-text/40 text-xs italic font-serif">
